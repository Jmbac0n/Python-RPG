...
def start_combat(m_name, m_health, m_attack, m_e_rating):
    ...
    def player_turn():
        ...
        if player_input == ("1"):
            ...
            slow_type(Python_RPG_Combat_Text.player_attack_text % (str(monster_name), (p_atk), (monster_health))) # Got to here last night - finish changing combat text
        elif player_input == ("2"):
